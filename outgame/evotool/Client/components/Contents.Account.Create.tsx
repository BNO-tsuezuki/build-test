...
type Props = Property & typeof AccountsStore.actionCreators;
...
export default class AccountCreate extends React.Component<Props, State> {
      ...
      <div style={{display:"flex", justifyContent:"center", alignItems:"center",
        ...
        <div style={{textAlign:"center", outline:"none" }}>
          ...
          <div style={{margin:"40px", color:"white"}}>
            emailアドレス (例:yodaredako@bandainamco-ol.co.jp)
            <div>
          ...
          <div style={{margin:"40px", color:"white"}}>
            氏名 (本名。デバック情報として使用します。ゲーム中に表示されるものではありません)
            <div>
              <input style={style} type="text" name="nickname" placeholder="氏名"
                  onChange={(e) => { this.nickname = e.target.value;}} />
            </div>
          </div>

          <div>
            <CircleBtn text="作成" size={120} color={0xf9a9ae} fontSize={20}
              onClick={
                () => {
                  this.setState({show:false});
