...
const store = new Vuex.Store({
    ...
    getters: {
        ...
        publisher: function (state) {
            if (state.loginInfo.publisher) {
                return state.loginInfo.publisher;
            } else {
                return '';
            }
        },
        publisherName: function (state) {
            if (state.loginInfo.publisher) {
                return state.loginInfo.publisher.publisherName;
            } else {
                return '';
            }
        },
