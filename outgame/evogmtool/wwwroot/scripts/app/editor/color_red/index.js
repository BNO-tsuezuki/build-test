...
class RedText {
  ...
  wrap(range) {
    ...
    let marker = document.createElement(this.tag);
      ...
      marker.classList.add(RedText.CSS);
   ...
   */
  get toolboxIcon() {
      return '<svg xmlns="http://www.w3.org/2000/svg" width="26" height="16" viewBox="0 0 16 14"><text x="0" y="12" font-family="Verdana" font-size="15" font-weight="bold" style="color: red">T</text></svg>';
  }
