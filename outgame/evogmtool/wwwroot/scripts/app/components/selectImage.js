Vue.component('vue-select-image', {
    template: `
          <div :class="rootClass">
            <ul :class="vue-select-image__wrapper">
              <li v-for="(dataImage, index) in dataImagesLocal" :key="index" :class="vue-select-image__item">
                <div
                ...
                >
                  <img
                    ...
                    :height="h"
                    :width="w"
                    :class="vue-select-image__img"
                  />

                  <label :for="dataImage.id" v-if="useLabel" :class="vue-select-image__lbl">{{dataImage.alt}}</label>
                </div>
